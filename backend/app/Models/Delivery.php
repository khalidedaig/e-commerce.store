...
class Delivery extends Model
{
  ...
  {
    $value = new Money(ceil($this->subTotal), new Currency(request()->currency), true);
  ...
  {
    $value = new Money(ceil($this->totalDiscount), new Currency(request()->currency), true);
    return $value->formatWithoutZeroes();
  }
  ...
  {
    $value = new Money(ceil($this->grandTotal), new Currency(request()->currency), true);
    return $value->formatWithoutZeroes();
  }
}
