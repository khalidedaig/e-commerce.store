    ...
    <div class="container">
      <div class="mx-auto">
        ...
        <form @submit.prevent="login" autocomplete="off">
          <!-- number found notice -->
          <div
            class="flex items-center mb-4 text-green-500"
            v-if="customerExist"
          >
            <info-icon></info-icon>
            <h5 class="text-md ml-1">
            ...
            <div class="">
              ...
              <div class="mt-4">
                <form-input
                  ...
                  class="w-full"
                  :disabled="$auth.loggedIn"
                  v-if="!$auth.loggedIn && !customerExist"
          ...
          <!-- button and links -->
          <form-button class="w-36 mt-4" v-if="customerExist"
            >Sign In</form-button
          >
        </form>
            ...
            <div>
              ...
              <div class="mt-3">
                <div>
                  ...
                  ></form-input>
                  <form-error
                    :message="validationErrors['billingAddress.street']"
                    class="mt-2"
                  />
                </div>
                <div class="mt-4">
                  ...
                  ></form-input>
                  <form-error
                    :message="validationErrors['billingAddress.city']"
                    class="mt-2"
                  />
                </div>
                <div class="mt-4">
                  ...
                  ></form-input>
                  <form-error
                    :message="validationErrors['billingAddress.state']"
                    class="mt-2"
                  />
                </div>
                <div class="mt-4">
                  ...
                  ></form-input>
                  <form-error
                    :message="validationErrors['billingAddress.zipcode']"
                    class="mt-2"
                  />
                </div>
                <div class="mt-4">
                  ...
                  ></form-select>
                  <form-error
                    :message="validationErrors['billingAddress.country']"
                    class="mt-2"
                  />
                </div>
              </div>
              <form-checkbox
                tiny
                class="mt-4"
                v-model="shippingIsSame"
                @change="setShipping"
              >
                <template #label>
                  <span class="pl-6 text-sm">
                    <span class="font-semibold">Shipping address</span> is same
                    as <span class="font-semibold">Billing Address</span>
                  </span>
                </template>
              </form-checkbox>
            </div>
            <div>
              ...
              <div class="mt-3">
                <div>
                  ...
                  ></form-input>
                  <form-error
                    :message="validationErrors['shippingAddress.street']"
                    class="mt-2"
                  />
                </div>
                <div class="mt-4">
                  ...
                  ></form-input>
                  <form-error
                    :message="validationErrors['shippingAddress.city']"
                    class="mt-2"
                  />
                </div>
                <div class="mt-4">
                  ...
                  ></form-input>
                  <form-error
                    :message="validationErrors['shippingAddress.state']"
                    class="mt-2"
                  />
                </div>
                <div class="mt-4">
                  <form-input
                    class="w-full"
                    placeholder="Zipcode"
                    v-model="formData.shippingAddress.zipcode"
                  ></form-input>
                  <form-error
                    :message="validationErrors['shippingAddress.zipcode']"
                    class="mt-2"
                  />
                </div>
                <div class="mt-4">
                  ...
                  ></form-select>
                  <form-error
                    :message="validationErrors['shippingAddress.country']"
                    class="mt-2"
                  />
                </div>
              </div>
      ...
      <div class="mt-10">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <div class="bg-gray-200 px-4 py-6 rounded-md">
          ...
          <div>
            ...
            <!-- paymemt options -->
            <div class="bg-white border rounded-md px-5 py-6">
              <div class="flex items-center">
                ...
                />
                <label class="font-semibold text-sm" for="cod">
              ...
              <div class="flex items-center mt-4">
                <input
                  ...
                  v-model="paymentMethod"
                />
                <label class="font-semibold text-sm text-gray-400" for="bkash"
                  >Bkash Payment</label
                >
              </div>
              <div class="flex items-center mt-4">
                <input
                  ...
                  v-model="paymentMethod"
                />
                <label class="font-semibold text-sm text-gray-400" for="nagad">
                  Nagad Payment</label
                >
              </div>
            </div>
            ...
            <div class="mt-4">
              <form-button
                type="button"
                @click="placeOrder"
                class="py-3 w-full uppercase tracking-widest"
                :class="{ 'opacity-25': !canPlaceOrder || isRequestProcessing }"
                :disabled="!canPlaceOrder || isRequestProcessing"
