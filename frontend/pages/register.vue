<template>
  <div class="py-10">
    <div class="container flex flex-col items-center justify-center">
      <h3 class="font-bold text-3xl mb-4 text-primary-500">
        Create an Acoount
      </h3>
      <form
        @submit.prevent="register"
        class="w-full bg-white border max-w-lg px-4 py-8 rounded-md shadow-lg mt-5"
      >
        <!-- First Name -->
        <div class="">
          <form-label
        ...
        <div class="my-4 text-center">
          <p class="text-sm">
            ...
            <nuxt-link to="/login" class="text-primary-500 hover:underline"
              >Sign In</nuxt-link
            >
          </p>
        </div>
