  ...
  <loader :loading="$fetchState.pending">
    ...
    >
      ...
      <detail-section
        class="border-b"
        label="Sub Total"
        :value="delivery.subTotalFormatted"
      ></detail-section>
      ...
      <detail-section
        ...
        :value="delivery.totalDiscountFormatted"
      ></detail-section>
      ...
      <detail-section
        class="border-b"
        label="Grand Total"
        :value="delivery.grandTotalFormatted"
      ></detail-section>
      ...
      <detail-section class="border-b" label="Billing Address">
        <p class="text-90" v-if="delivery.billingAddress">
          {{ delivery.billingAddress.street }},
          {{ delivery.billingAddress.city }},
          {{ delivery.billingAddress.country }} -
          {{ delivery.billingAddress.zipcode }}
        </p>
        <p v-else>-</p>
      </detail-section>
      ...
      <detail-section class="border-b" label="Shipping Address">
        <p class="text-90" v-if="delivery.shippingAddress">
      ...
      <template #secondary-view>
        ...
        <div class="rounded-md overflow-hidden shadow-sm border mt-4">
            ...
            <table>
              ...
              <tbody>
                ...
                >
                  ...
                  <td>{{ item.quantity }} {{ item.unit.code }}</td>
