<template>
  <div>
    <p class="flex bg-green-100 rounded-md px-4 py-3 text-sm text-green-700">
    ...
    <form class="mt-3" @submit.prevent="saveAddress">
            ...
            >
              <template #label>
                <span class="text-sm ml-6">
                  <span class="font-semibold">Shipping Address</span> is same as
      ...
      <form-button
        :class="{ 'opacity-25': isRequestProcessing }"
        :disabled="isRequestProcessing"
        class="bg-primary-500 text-white px-10 mt-4"
        >Save</form-button
      >
    </form>
  </div>
