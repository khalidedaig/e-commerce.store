...
.btn {
  @apply inline-flex bg-white items-center px-4 py-2 shadow-md border border-transparent rounded-md text-xs uppercase tracking-widest transition;
}
...
.badge {
  @apply inline-flex items-center justify-center px-3 py-1 text-xs uppercase font-semibold leading-none text-white rounded-md;
}
</style>
