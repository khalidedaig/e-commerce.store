<template>
  <dropdown :width="80">
    <template #trigger>
      <button
        class="ti-bell px-4 relative text-xl text-gray-800 rounded-full hover:text-primary-500 focus:outline-none focus:text-primary-600 transition duration-150 ease-in-out"
      >
        <span
          class="bg-primary-500 text-white text-xs absolute w-5 h-5 rounded-md flex items-center justify-center border border-white"
    ...
    <template #content>
      ...
      <div class="p-3 border-b">
        <div class="flex items-center">
          <p class="font-semibold text-sm">Notifications ({{ length }})</p>
          <span
      ...
      <div style="max-height: 245px; overflow: auto">
        ...
        <div v-else>
          <div class="text-gray-500 text-center w-full py-3 border-b text-sm">
