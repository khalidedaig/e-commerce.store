    ...
    <dropdown width="72" class="hidden md:flex">
      <template #trigger>
        <div class="cursor-pointer">
          ...
          <div
            ...
            class="absolute -top-2.5 -right-2.5 bg-primary-500 h-5 w-5 rounded-md flex items-center justify-center"
          >
            <span
              class="inline-block mb-0 text-xs text-white whitespace-nowrap"
              >{{ totalItems }}</span
            >
          </div>
        </div>
      ...
      <template #content="{ close }">
        <div class="bg-white">
          <div v-if="cartItems && cartItems.length">
            ...
            <div class="overflow-y-auto" style="height: 295px">
              ...
              >
                ...
                <!-- items -->
                <div
                  class="flex items-center justify-between font-semibold text-sm mt-4"
                >
                  <div class="w-28">
                    <form-input-group
                  ...
                  <span
                    >Total:
                    {{ currencyFormat(item.quantity * item.price) }}</span
                  >
                </div>
              </div>
            </div>
            ...
            <div class="py-3 px-4 bg-gray-50">
              <div
                class="text-right flex items-center justify-between font-semibold text-sm mt-1"
              >
          ...
          <div v-else class="py-3 px-4 h-16 flex items-center justify-center">
            No Items Added!
          </div>
        </div>
      </template>
