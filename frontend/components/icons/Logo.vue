<template>
	<!-- <svg viewBox="0 0 48 48" class="fill-current text-primary-500" xmlns="http://www.w3.org/2000/svg">
	...
	<img src="images/logo.gif" alt="" class="inline-block h-15 w-15 rounded-full" >
</template>
